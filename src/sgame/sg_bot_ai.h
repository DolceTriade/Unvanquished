...
AINodeStatus_t BotActionFirePrimary( gentity_t *self, AIGenericNode_t *node );
AINodeStatus_t BotActionFireSecondary( gentity_t *self, AIGenericNode_t *node );
AINodeStatus_t BotActionFireTertiary( gentity_t *self, AIGenericNode_t *node );
